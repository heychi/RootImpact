    ...
    <div>
      ...
      <div className="recommendation-page">
        ...
        <div className="basic-info-dropdown">
          ...
          >
            기본 정보 변경 | 고객님이 입력하신 정보를 바탕으로 표시합니다.{' '}
            {dropdownOpen ? '▲' : '▼'}
          </button>
          {dropdownOpen && (
                  ...
                  {['해상', '항공', '특송'].map((option) => (
                    <span
                      ...
                      className={`option-item ${
                        basicInfo.transport.includes(option) ? 'selected' : ''
                      }`}
                ...
                <div className="option-group">
                  {['일반', '냉장', '냉동'].map((option) => (
                    <span
                      key={option}
                      className={`option-item ${
                        basicInfo.cargoType.includes(option) ? 'selected' : ''
                      }`}
                ...
                <div className="option-group">
                  {['FCL', 'LCL'].map((option) => (
                    <span
                      key={option}
                      className={`option-item ${
                        basicInfo.cargoSize === option ? 'selected' : ''
                      }`}
                      onClick={() =>
